...
The current system, where the AI model generates a JSON object containing a list of `tool\_calls`, presents a significant challenge for real-time applications:
